...
\subsection*{Problem Solution}
\begin{align*}
u &= t^4 \quad\Rightarrow\quad du = 4t^3 \cdot dt\\
dv &= e^{-3t}\cdot dt \quad\Rightarrow\quad v = -\frac{1}{3}e^{-3t}\\\\
\int_0^\infty t^4 e^{-3t} \cdot dt & = -\frac{t^4}{3}e^{-3t}\biggr\rvert_0^\infty - \int_0^\infty -\frac{4}{3}e^{-3t} t^3 \cdot dt
\end{align*}

\begin{align*}
u &= t^3 \quad\Rightarrow\quad du = 3t^2\\
dv &= te^{-3t}\\
v &= \int te^{-3t}\cdot dt = -\frac{3t + 1}{9}e^{-3t}\\
\end{align*}
