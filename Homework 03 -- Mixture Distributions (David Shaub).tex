...
\end{align*}
Then we calculate the final undoncitioned probability for the whole computer:
\begin{align*}
P &= P_{Maxx}\cdot 0.35 + P_{Ultra}\cdot 0.25 + P_{Super}\cdot 0.40\\
P &= 0.4298168 \cdot 0.35 + 0.450989 cdot 0.25 + 0.3877519 \cdot 0.40 \approxeq 0.41828
\end{align*}
