...
P(X=2|maxx) &= 0.07623965 &P(X=2|ultra) &= 0.07352571 &P(X=2|super) &= 0.1169058\\
\end{align*}
{\tiny
\begin{align*}
P(super|data) &= \frac{P(data|super) \cdot P(super)}{P(data|super) \cdot P(super) + P(data|maxx) \cdot P(maxx) + P(data|ultra) \cdot P(ultra)}\\
&= \frac{0.1169058 \cdot 0.1}{0.1169058 \cdot 0.1 + 0.07623965 \cdot 0.45 + 0.07352571 \cdot 0.45}\\
&= 0.147823
\end{align*}}%
\newpage
...
&= \frac{0.8 \cdot .004}{0.8 \cdot .004 + 0.1 \cdot 0.996}\\
&= 0.0311284
\end{align*}
...
P(D^+) &= 0.02 \\
P(D^-) &= 0.98 \\
P(T^+|D^+) &= P(X \geq 28|\mu = 38) = 0.9611251\\
...
\begin{align*}
PPV = P(D^+|T^+) &= \frac{P(T^+|D^+) \cdot P(D^+)}{P(T^+|D^+) \cdot P(D^+) + P(T^+|D^-) \cdot P(D^-)}\\
&= \frac{0.9611251 \cdot 0.02}{0.9611251 \cdot 0.02 + 0.08254069 \cdot 0.98}\\
&= 0.1920092
\end{align*}
...
\begin{align*}
NPV = P(D^-|T^-) &= \frac{P(T^-|D^-) \cdot P(D^-)}{P(T^-|D^-) \cdot P(D^-) + P(T^-|D^+) \cdot P(D^+)}\\
&= \frac{0.9174593 \cdot 0.98}{0.9174593 \cdot 0.98 + 0.03887492 \cdot 0.02}\\
&= 0.999136
\end{align*}
...
\begin{align*}
P(T^+|D^+) &= \frac{P(D^+|D^+) \cdot P(D^+)}{P(D^+|D^+) \cdot P(D^+) + P(D^+|D^-) \cdot P(D^-)}\\
&= \frac{0.17043 \cdot 0.16370}{0.17043 \cdot 0.16370 + 0.00251 \cdot 0.8363}\\
&= 0.9300261
\end{align*}

{\bf Part (b)}\ What is the specificity of the test?
\begin{align*}
P(T^-|D^-) &= \frac{P(D^-|T^-) \cdot P(T^-)}{P(D^-|T^-) \cdot P(T^-) + P(D^-|T^+) \cdot P(T^+)}\\
&= \frac{0.99749 \cdot 0.8363}{0.99749 \cdot 0.8363 + 0.82957 \cdot 0.16370}\\
&= 0.8599996
\end{align*}
